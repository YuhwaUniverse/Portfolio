...
## 3. SQL Queries and their Results 
 ...
 #### 4) These SQL queries are designed by editing and applying the problems in the webpage  
 #### &nbsp;&nbsp;&nbsp; where i downloaded the database, with the sole purpose to show the basic knowledge of RDBM using SQL queries.
